...
import numpy as np
from .baseinvocation import BaseInvocation, BaseInvocationOutput, InputField, OutputField, InvocationContext, invocation, invocation_output, UIType, Input
...
class ValueToValueInvocation(BaseInvocation):
    ...
    round_multiple: int = InputField(default=1, ge=1, title="Multiple of", description="The multiple to round to for float to integer")
