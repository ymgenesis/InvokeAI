...
from .invocations.baseinvocation import BaseInvocation, UINodeConfig, UIOutputConfig
...
def custom_openapi():
    ...
    ui_config_schemas = schema([UINodeConfig, UIOutputConfig], ref_prefix="#/components/schemas/")
